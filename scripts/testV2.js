...
async function main() {
   ...
   const factory = await ethers.getContractFactory("ExampleV2", wallet);
   ...
   console.log(" Result After1: " + result2)
   await contract.decrease()
   const result3 = await contract.retrieve()
   console.log(" Result After2: " + result3)
}
